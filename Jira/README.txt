----------------------------------------------
Jira 9.15.0-#9150000 README
----------------------------------------------

Thank you for downloading Jira 9.15.0. This distribution comes with a
built-in Tomcat 9.0.87 application server, so it runs (almost)
out of the box.
...
Full documentation:
http://docs.atlassian.com/jira/jadm-docs-0915/Installing+Jira+applications
...
2. Set the JAVA_HOME variable to where you installed Java.
   ...
   http://docs.atlassian.com/jira/jadm-docs-0915/Installing+Java

3. Set your Jira home directory.

   See the following instructions for details:
   http://docs.atlassian.com/jira/jadm-docs-0915/Setting+your+Jira+application+home+directory
...
Full documentation:
http://docs.atlassian.com/jira/jadm-docs-0915/Upgrading+Jira+applications
...
-  Complete the pre-upgrade steps that include running a Jira health check,
   ...
   See the following instructions for details:
   http://docs.atlassian.com/jira/jadm-docs-0915/Preparing+for+the+upgrade
...
3. If you're using an Oracle or MySQL database, download the database driver
   ...
   Supported drivers:
   http://docs.atlassian.com/jira/jadm-docs-0915/Supported+platforms
...
Try the docs at:
http://docs.atlassian.com/jira/jadm-docs-0915/
