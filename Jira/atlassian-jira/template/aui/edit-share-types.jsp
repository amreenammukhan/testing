...
<div class="<ww:property value="parameters['mode']"/>">
    <page:applyDecorator name="auifieldgroup">
        ...
        <div role="status" aria-atomic="true" aria-live="polite" id="share_display_div_<ww:property value="parameters['mode']"/>"></div>
        ...
        <fieldset>
            <legend class="accessible">
                <ww:if test="parameters['mode'] == 'viewers'">
                    <ww:text name="'common.sharing.new.viewers'"/>
                </ww:if>
                <ww:if test="parameters['mode'] == 'editors'">
                    <ww:text name="'common.sharing.new.editors'"/>
                </ww:if>
            </legend>
            <ww:property value="parameters['shareTypeList']">
                <div id="share_div_<ww:property value="parameters['mode']"/>" style="display: none;">
                    ...
                    <div id="share_display_component_<ww:property value="parameters['mode']"/>"><ww:if test=". != null && ./size > 0">
                        <div>
                            <label for="share_type_selector_<ww:property value="parameters['mode']"/>" style="display:none;">
                                <ww:if test="parameters['mode'] == 'viewers'">
                                    <ww:text name="'common.sharing.viewers'"/>
                                </ww:if>
                                <ww:if test="parameters['mode'] == 'editors'">
                                    <ww:text name="'common.sharing.editors'"/>
                                </ww:if>
                            </label>
                            ...
                            <span class="share_select" id="share_<ww:property value="./shareType"/>_<ww:property value="parameters['mode']"/>" <ww:if test="@typeStatus/first == false">style="display:none"</ww:if>>
                                ...
                                <ww:if test="./addButtonNeeded == true">
                                    <button type="button" class="addShare m-add-btn" id="share_add_<ww:property value="./shareType"/>_<ww:property value="parameters['mode']"/>">
                ...
                <label for="share_type_hidden_<ww:property value="parameters['mode']"/>" style="display:none;">
                    <ww:if test="parameters['mode'] == 'viewers'">
                        <ww:text name="'common.sharing.viewers'"/>
                    </ww:if>
                    <ww:if test="parameters['mode'] == 'editors'">
                ...
                <button type="button" id="share_trash_<ww:property value="parameters['mode']"/>" class="aui-icon m-trash-btn aui-icon-small aui-iconfont-delete shareTrash" style="display:none;"><ww:text name="'common.sharing.delete.share'"/></button>
