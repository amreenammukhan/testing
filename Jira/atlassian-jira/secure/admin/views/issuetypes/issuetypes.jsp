...
<table class="aui" id="issue-types-table">
    <thead>
        <tr>
            ...
            <th>
                <ww:text name="'common.words.actions'"/>
            </th>
        </tr>
    </thead>
    <tbody>
    ...
    <tr>
        <td class="cell-type-key" id="type<ww:property value="id"/>">
            ...
            <strong data-issue-type-field="name"><ww:property value="nameTranslation"/></strong>
            <div class="description secondary-text"><ww:property value="descTranslation"/></div>
        </td>
        <ww:if test="../typeEnabled == true">
