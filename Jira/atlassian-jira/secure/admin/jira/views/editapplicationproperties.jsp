...
<page:applyDecorator name="jiraform">
    ...
    <tr>
        <td class="fieldLabelArea">
            <ww:text name="'admin.generalconfiguration.globalsharing'">
                <ww:param name="'value0'"><br/></ww:param>
            </ww:text>
        </td>
        <td class="fieldValueArea">
            <input id="globalSharingOn" type="radio" class="radio" value="true" name="globalSharing" <ww:if test="globalSharing == true">checked="checked"</ww:if>/><label for="globalSharingOn"><ww:text name="'admin.common.words.on'"/></label>
            &nbsp;
            <input id="globalSharingOff" type="radio" class="radio" value="false" name="globalSharing" <ww:if test="globalSharing == false">checked="checked"</ww:if>/><label for="globalSharingOff"><ww:text name="'admin.common.words.off'"/></label>
            <div class="fieldDescription">
                <ww:text name="'admin.generalconfiguration.globalsharing.description'"/>
            </div>
        </td>
    </tr>
            ...
            <ww:else>
                <ww:if test="hasUnassignedIssues == true">
                    ...
                    <ww:text name="'admin.generalconfiguration.allow.unassigned.issues.error1'">
                        ...
                        <ww:param name="'value1'"><ww:property value="unassignedIssueCount"/> <a href="<ww:url value="'/issues/'" atltoken="false" />"></ww:param>
    ...
    <tr>
        ...
        <td>
            <input type="radio" class="radio" value="true" name="projectDescriptionHtmlEnabled"
                   <ww:if test="/projectDescriptionHtmlEnabled == true">checked</ww:if>> <ww:text
                name="'admin.common.words.on'"/>
            &nbsp;
            <input type="radio" class="radio" value="false" name="projectDescriptionHtmlEnabled"
                   <ww:if test="/projectDescriptionHtmlEnabled == false">checked</ww:if>> <ww:text
                name="'admin.common.words.off'"/>
            <br><span class="subText">
    ...
    <tr>
        <td class="fieldLabelArea">
            <ww:text name="'admin.generalconfiguration.custom.field.html.enabled.label'"></ww:text>
        </td>
        <td>
            <label><input type="radio" class="radio" value="true" name="customFieldHtmlEnabled" <ww:if test="/customFieldHtmlEnabled == true">checked</ww:if>> <ww:text name="'admin.common.words.on'"/></label>
            &nbsp;
            <label><input type="radio" class="radio" value="false" name="customFieldHtmlEnabled" <ww:if test="/customFieldHtmlEnabled == false">checked</ww:if>> <ww:text name="'admin.common.words.off'"/></label>
            <br><span class="subText">
                <ww:text name="'admin.generalconfiguration.custom.field.html.enabled.description'"/>
            </span>
        </td>
    </tr>
    ...
    <tr>
        <td class="fieldLabelArea">
            <ww:text name="'admin.generalconfiguration.empty.jql.returns.no.data.label'"></ww:text>
        </td>
        <td>
            <label><input type="radio" class="radio" value="true" name="emptyJqlReturnsNoDataEnabled" <ww:if test="/emptyJqlReturnsNoDataEnabled == true">checked</ww:if>> <ww:text name="'admin.common.words.on'"/></label>
            &nbsp;
            <label><input type="radio" class="radio" value="false" name="emptyJqlReturnsNoDataEnabled" <ww:if test="/emptyJqlReturnsNoDataEnabled == false">checked</ww:if>> <ww:text name="'admin.common.words.off'"/></label>
            <br><span class="subText">
                <ww:text name="'admin.generalconfiguration.empty.jql.returns.no.data.description'"/>
            </span>
        </td>
    </tr>
    ...
    <tr>
        <td class="fieldLabelArea">
            <ww:text name="'admin.generalconfiguration.csv.export.dialog.enabled.label'"></ww:text>
        </td>
        <td>
            <label><input type="radio" class="radio" value="true" name="csvExportDialogEnabled" <ww:if test="/csvExportDialogEnabled == true">checked</ww:if>> <ww:text name="'admin.common.words.on'"/></label>
            &nbsp;
            <label><input type="radio" class="radio" value="false" name="csvExportDialogEnabled" <ww:if test="/csvExportDialogEnabled == false">checked</ww:if>> <ww:text name="'admin.common.words.off'"/></label>
            <br><span class="subText">
                <ww:text name="'admin.generalconfiguration.csv.export.dialog.enabled.description'"/>
            </span>
        </td>
    </tr>
    <ui:textfield label="text('admin.generalconfiguration.favourite.filters.jql.execution.timeout.label')" name="'favouriteFiltersGadgetMaxTimeout'">
        <ui:param name="'size'">15</ui:param>
        <ui:param name="'description'">
            <ww:text name="'admin.generalconfiguration.favourite.filters.jql.execution.timeout.description'"/>
        </ui:param>
    </ui:textfield>

    <tr>
        <td class="fieldLabelArea"><ww:text name="'admin.generalconfiguration.xsrf.dialog.urlparams.display.label'"></ww:text></td>
        <td>
            <input type="radio" class="radio" value="true" name="xsrfDialogDisplayParamsEnabled"
                   <ww:if test="/xsrfDialogDisplayParamsEnabled == true">checked</ww:if>> <ww:text
                name="'admin.common.words.on'"/>
            &nbsp;
            <input type="radio" class="radio" value="false" name="xsrfDialogDisplayParamsEnabled"
                   <ww:if test="/xsrfDialogDisplayParamsEnabled == false">checked</ww:if>> <ww:text
                name="'admin.common.words.off'"/>
            <br><span class="subText">
                <ww:text name="'admin.generalconfiguration.xsrf.dialog.urlparams.display.description'"></ww:text>
            </span>
        </td>
    </tr>
    <ww:if test="commentReactionsEnabled == true">
    <tr>
        <td class="fieldLabelArea"><ww:text name="'admin.generalconfiguration.enable.issue.comment.reactions.label'"></ww:text></td>
        <td>
            <input type="radio" class="radio" value="true" name="issueCommentReactionsEnabled"
                   <ww:if test="/issueCommentReactionsEnabled == true">checked</ww:if>> <ww:text
                name="'admin.common.words.on'"/>
            &nbsp;
            <input type="radio" class="radio" value="false" name="issueCommentReactionsEnabled"
                   <ww:if test="/issueCommentReactionsEnabled == false">checked</ww:if>> <ww:text
                name="'admin.common.words.off'"/>
            <br><span class="subText">
                <ww:text name="'admin.generalconfiguration.enable.issue.comment.reactions.description'"></ww:text>
            </span>
        </td>
    </tr>
    </ww:if>
    ...
    <ww:if test="/systemAdministrator == true">
    <tr>
        <td class="fieldLabelArea"><ww:text name="'admin.generalconfiguration.stacktrace'"></ww:text></td>
        <td>
            <label><input type="radio" class="radio" value="true" name="stacktraceEnabled" <ww:if test="/stacktraceEnabled == true">checked</ww:if>> <ww:text name="'admin.common.words.on'"/></label>
            &nbsp;
            <label><input type="radio" class="radio" value="false" name="stacktraceEnabled" <ww:if test="/stacktraceEnabled == false">checked</ww:if>> <ww:text name="'admin.common.words.off'"/></label>
            <br><span class="subText">
            <ww:text name="'admin.generalconfiguration.stacktrace.description'"/>
        </span>
        </td>
    </tr>
    </ww:if>
    <ww:if test="/systemAdministrator == true">
        <tr>
            <td class="fieldLabelArea">
                <ww:text name="'admin.jira.self.creation.type'"/>
            </td>
            <td class="fieldValueArea">
                <input type="radio" class="radio" value="HOST_FROM_REQUEST" id="hostFromRequestType" name="selfUrlOriginType"
                       <ww:if test="selfUrlOriginType == 'HOST_FROM_REQUEST'">checked="checked"</ww:if>/><label
                    for="hostFromRequestType"><ww:text name="'admin.jira.self.url.origin.host.from.request'"/></label>
                &nbsp;
                <input type="radio" class="radio" value="BASEURL" id="baseurlType" name="selfUrlOriginType"
                       <ww:if test="selfUrlOriginType == 'BASEURL'">checked="checked"</ww:if>/><label
                    for="baseurlType"><ww:text name="'admin.jira.self.url.origin.baseurl'"/></label>
                &nbsp;
                <input type="radio" class="radio" value="ALLOW_LIST" id="allowHostListType" name="selfUrlOriginType"
                       <ww:if test="selfUrlOriginType == 'ALLOW_LIST'">checked="checked"</ww:if>/><label
                    for="allowHostListType"><ww:text name="'admin.jira.self.url.origin.allow.list'"/></label>
                <br><span class="subText"><ww:text
                    name="'admin.generalconfiguration.self.url.origin.description'"></ww:text></span>
            </td>
        </tr>
    </ww:if>
</page:applyDecorator>
