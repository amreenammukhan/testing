    ...
    <aui:component template="module.jsp" theme="'aui'">
        ...
        <aui:param name="'contentHtml'">
            ...
            <table class="aui aui-table-rowhover" id="table-AttachmentSettings">
                <caption>
                    <ww:text name="'admin.attachmentsettings.section.general'"/>
                </caption>
                <tbody>
            ...
            <table class="aui aui-table-rowhover" id="table-SecuritySettings">
                <caption>
                    <ww:text name="'admin.attachmentsettings.section.security'"/>
                </caption>
                <tbody>
                    <tr data-attachment-setting="extension-restriction-mode">
                        <td style="width: 40%" data-cell-type="label">
                            <strong><ww:text name="'admin.attachmentsettings.extension.restriction.mode'"/></strong>
                            <div class="secondary-text">
                                <ww:text name="'admin.attachmentsettings.extension.restriction.mode.explanation'"/>
                            </div>
                        </td>
                        <td style="width: 60%" data-cell-type="value">
                            <ww:if test="/extensionRestrictionMode == 'none'">
                                <strong><ww:text name="'admin.attachmentsettings.extension.restriction.mode.none'"/></strong>
                                <div class="secondary-text">
                                    <ww:text name="'admin.attachmentsettings.extension.restriction.mode.none.explanation'"/>
                                </div>
                            </ww:if>
                            <ww:if test="/extensionRestrictionMode == 'blocklist'">
                                <strong><ww:text name="'admin.attachmentsettings.extension.restriction.mode.blocklist'"/></strong>
                                <div class="secondary-text">
                                    <ww:text name="'admin.attachmentsettings.extension.restriction.mode.blocklist.explanation'"/>
                                </div>
                            </ww:if>
                            <ww:if test="/extensionRestrictionMode == 'allowlist'">
                                <strong><ww:text name="'admin.attachmentsettings.extension.restriction.mode.allowlist'"/></strong>
                                <div class="secondary-text">
                                    <ww:text name="'admin.attachmentsettings.extension.restriction.mode.allowlist.explanation'"/>
                                </div>
                            </ww:if>
                        </td>
                    </tr>
                    <tr data-attachment-setting="filtered-file-extensions">
                        <td data-cell-type="label">
                            <strong><ww:text name="'admin.attachmentsettings.filtered.file.extensions'"/></strong>
                            <div class="secondary-text">
                                <ww:text name="'admin.attachmentsettings.filtered.file.extensions.explanation'"/>
                            </div>
                        </td>
                        <td data-cell-type="value">
                            <ww:property value="filteredFileExtensions"/>
                        </td>
                    </tr>
                    <tr data-attachment-setting="filter-files-without-extensions">
                        <td data-cell-type="label">
                            <strong><ww:text name="'admin.attachmentsettings.filter.files.without.extensions'"/></strong>
                        </td>
                        <td data-cell-type="value">
                            <ww:if test="/filterFilesWithoutExtensions == true">
                                <ww:text name="'admin.attachmentsettings.filter.files.without.extensions.yes'"/>
                            </ww:if>
                            <ww:else>
                                <ww:text name="'admin.attachmentsettings.filter.files.without.extensions.no'"/>
                            </ww:else>
                        </td>
                    </tr>
                </tbody>
