        ...
        <page:applyDecorator name="auifieldset">
            ...
            <page:applyDecorator name="auifieldgroup">
                ...
                <div class="security-level">
                    ...
                    <a role="button" aria-labelledby="currentLevel" class="drop" href="#"><span class="security-level-drop-icon aui-icon aui-icon-small aui-iconfont-<ww:if test="/commentLevel == null">unlocked</ww:if><ww:else>locked</ww:else>"></span><span class="icon drop-menu"></span></a>
                    ...
                    <span class="current-level" id="currentLevel"><ww:property value="/selectedLevelName" escape="false" /></span>
                </div>
            </page:applyDecorator>
        </page:applyDecorator>


        <ww:if test="/displayMarketplaceLink == true">
            <img src="<%= ComponentAccessor.getWebResourceUrlProvider().getStaticResourcePrefix(UrlMode.AUTO) %>/images/icons/marketplace-ico.png" alt="" role="presentation" width="16" height="16" border="0" style="padding-left: 5px"/>
