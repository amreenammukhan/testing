AJS.test.require("jira.webresources:jira-setup", function () {
    ...
    var viewConfiguration = {
        errors: {},
        databaseOptions: {},
        externalDatabases: [dbData("mssql", true), dbData("mysql8"), dbData("oracle10g"), dbData("postgres72")],
        helpPaths: {
    ...
    test("DB fields are hidden and shown on changing db type.", function () {
        ...
        _.each(morphIntoPairs("mssql", ["mysql8", "oracle10g", "postgres72"]), function (dbs) {
            setDbType(dbs.newDb);
